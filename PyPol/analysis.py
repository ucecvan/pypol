...
class Combine(object):
    ...
    def __init__(self, name, method, cvs):
        ...
        self.type = "{} ({}D)".format(cvs[0].type, len(cvs))
        self.clustering_type = "distribution"
        self.method = method
        ...
        for crystal in list_crystals:
            ...
            if os.path.exists(path_output):
                ...
                if len(self.cvs) == 2:
                    ...
                    extent = self.cvs[0].grid_min, self.cvs[0].grid_max, self.cvs[1].grid_min, self.cvs[1].grid_max

                    plt.imshow(crystal.cvs[self.name], interpolation="nearest", cmap="viridis", extent=extent)
